...
rd/s /q %DESTINATION%\Unity\Assets\Scripts\Game\Library\ET\Runtime\Core
rd/s /q %DESTINATION%\Unity\Assets\Scripts\Game\Library\ET\Runtime\ThirdParty
...
xcopy %SOURCE%\Unity\Assets\Scripts\Core %DESTINATION%\Unity\Assets\Scripts\Game\Library\ET\Runtime\Core /s /e /i
xcopy %SOURCE%\Unity\Assets\Scripts\ThirdParty %DESTINATION%\Unity\Assets\Scripts\Game\Library\ET\Runtime\ThirdParty /s /e /i
...
xcopy %SOURCE%\Config %DESTINATION%\Design /s /e /i
