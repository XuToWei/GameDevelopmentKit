...
namespace ET
{
    public class ServerMonitorNotifier
    {
        ...
        public event Action OnServerStatusChanged = delegate { };
        public event Action OnFibersChanged = delegate { };
        public event Action OnScenesChanged = delegate { };
        ...
        public void RemoveProcessData(int processId)
        {
            ...
            if (fiberRemoved) OnFibersChanged();
            if (sceneRemoved) OnScenesChanged();
        }
