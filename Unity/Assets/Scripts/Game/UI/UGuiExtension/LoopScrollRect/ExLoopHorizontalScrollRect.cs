...
{
    /// <summary>
    /// 横向循环列表：继承 LoopHorizontalScrollRect，内置对象池与数据源（无需再额外挂组件）。
    /// 用法：设置 itemRenderer 回调与 numItems 即可。
    /// </summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("UI/Ex Loop Horizontal Scroll Rect")]
    public class ExLoopHorizontalScrollRect : LoopHorizontalScrollRect, LoopScrollPrefabSource, LoopScrollDataSource
    {
        [SerializeField]
