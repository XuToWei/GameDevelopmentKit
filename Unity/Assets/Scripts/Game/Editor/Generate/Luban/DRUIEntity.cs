...
public sealed class DRUIEntity :  Luban.EditorBeanBase 
{
    public DRUIEntity()
    {
            CSName = "";
    ...
    public static DRUIEntity LoadJsonDRUIEntity(SimpleJSON.JSONNode _json)
    {
        DRUIEntity obj = new DRUIEntity();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonDRUIEntity(DRUIEntity _obj, SimpleJSON.JSONNode _json)
    {
