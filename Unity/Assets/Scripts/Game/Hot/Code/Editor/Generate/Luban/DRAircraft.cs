...
public sealed partial class DRAircraft :  Bright.Config.EditorBeanBase 
{
    public DRAircraft()
    {
    ...
    /// 武器编号0
    /// </summary>
    public System.Collections.Generic.List<int> WeaponIds { get; set; }

    /// <summary>
    /// 装甲编号0
    /// </summary>
    public System.Collections.Generic.List<int> ArmorIds { get; set; }
