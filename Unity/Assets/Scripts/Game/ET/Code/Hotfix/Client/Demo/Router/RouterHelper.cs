...
namespace ET.Client
{
    public static class RouterHelper
    {
        ...
        public static async UniTask<(uint, IPEndPoint)> GetRouterAddress(Scene clientScene, IPEndPoint address, uint localConn, uint remoteConn)
        {
        ...
        // 向router申请
        private static async UniTask<uint> Connect(IPEndPoint routerAddress, IPEndPoint realAddress, uint localConn, uint remoteConn)
        {
