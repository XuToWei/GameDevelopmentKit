...
namespace ET.Client
{
    ...
    {
        // 注册router
        public static async UniTask<Session> CreateRouterSession(Scene root, IPEndPoint address)
        {
        ...
        public static async UniTask<(uint, IPEndPoint)> GetRouterAddress(Scene root, IPEndPoint address, uint localConn, uint remoteConn)
        {
        ...
        // 向router申请
        private static async UniTask<uint> Connect(Scene root, IPEndPoint routerAddress, IPEndPoint realAddress, uint localConn, uint remoteConn)
        {
