...
namespace ET.Client
{
    ...
    public static partial class ClientSenderCompnentSystem
    {
        ...
        private static async UniTask RemoveFiberAsync(this ClientSenderCompnent self)
        {
            if (self.fiberId == 0)
            {
                return;
        ...
        public static async UniTask<long> LoginAsync(this ClientSenderCompnent self, string account, string password)
        {
        ...
        public static async UniTask<IResponse> Call(this ClientSenderCompnent self, IRequest request, bool needException = true)
        {
