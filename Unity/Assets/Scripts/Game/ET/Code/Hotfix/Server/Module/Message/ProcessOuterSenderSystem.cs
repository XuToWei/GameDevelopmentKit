...
namespace ET.Server
{
    ...
    public static partial class ProcessOuterSenderSystem
    {
        ...
        private static Session Get(this ProcessOuterSender self, long channelId)
        {
            ...
            IPEndPoint ipEndPoint = Tables.Instance.DTStartProcessConfig.Get(Options.Instance.StartConfig, (int) channelId).IPEndPoint;
        ...
        private static void SendInner(this ProcessOuterSender self, ActorId actorId, MessageObject message)
        {
            ...
            var startProcessConfig = Tables.Instance.DTStartProcessConfig.Get(Options.Instance.StartConfig, actorId.Process);
