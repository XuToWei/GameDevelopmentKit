...
namespace ET.Server
{
    public static class ActorHandleHelper
    {
        ...
        public static async UniTask HandleIActorRequest(long actorId, IActorRequest iActorRequest)
        {
        ...
        /// </summary>
        [EnableAccessEntiyChild]
        public static async UniTask HandleIActorMessage(long actorId, IActorMessage iActorMessage)
        {
            InstanceIdStruct instanceIdStruct = new(actorId);
            int fromProcess = instanceIdStruct.Process;
            instanceIdStruct.Process = Options.Instance.Process;
