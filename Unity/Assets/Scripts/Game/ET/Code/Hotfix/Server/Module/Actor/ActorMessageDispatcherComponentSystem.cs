...
namespace ET.Server
{
    ...
    {
        [EntitySystem]
        private class ActorMessageDispatcherComponentAwakeSystem : AwakeSystem<ActorMessageDispatcherComponent>
        {
        ...
        [EntitySystem]
        private class ActorMessageDispatcherComponentDestroySystem : DestroySystem<ActorMessageDispatcherComponent>
        {
        ...
        [EntitySystem]
        private class ActorMessageDispatcherComponentLoadSystem : LoadSystem<ActorMessageDispatcherComponent>
        {
        ...
        private static async UniTask Handle(this ActorMessageDispatcherComponent self, Entity entity, int fromProcess, object message)
        {
        ...
        public static async UniTask HandleIActorRequest(this ActorMessageDispatcherComponent self, int fromProcess, long actorId, IActorRequest iActorRequest)
        {
        ...
        /// </summary>
        [EnableAccessEntiyChild]
        public static async UniTask HandleIActorMessage(this ActorMessageDispatcherComponent self, int fromProcess, long actorId, IActorMessage iActorMessage)
        {
            Entity entity = self.Get(actorId);
            if (entity == null)
            {
