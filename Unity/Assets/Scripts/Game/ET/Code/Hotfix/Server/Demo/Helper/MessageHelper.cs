...
namespace ET.Server
{
    public static class MessageHelper
    {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static async UniTask<IActorResponse> CallActor(long actorId, IActorRequest message)
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static async UniTask<IActorResponse> CallLocationActor(long id, IActorLocationRequest message)
        {
