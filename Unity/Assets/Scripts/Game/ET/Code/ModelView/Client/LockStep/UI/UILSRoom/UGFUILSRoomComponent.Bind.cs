...
namespace ET.Client
{
    public partial class UGFUILSRoomComponent : CodeBind.ICSCodeBind
    {
        ...
        public void InitBind(CodeBind.CSCodeBindMono mono)
        {
            ...
            this.frameCountText = this.mono.bindComponents[0] as UnityEngine.UI.Text;
            this.jumpButton = this.mono.bindComponents[1] as UnityEngine.UI.Button;
            this.jumpToCountInputField = this.mono.bindComponents[2] as UnityEngine.UI.InputField;
            this.playTransform = this.mono.bindComponents[3] as UnityEngine.Transform;
            this.predictText = this.mono.bindComponents[4] as UnityEngine.UI.Text;
            this.progressText = this.mono.bindComponents[5] as UnityEngine.UI.Text;
            this.replayTransform = this.mono.bindComponents[6] as UnityEngine.Transform;
            this.saveNameInputField = this.mono.bindComponents[7] as UnityEngine.UI.InputField;
            this.saveReplayButton = this.mono.bindComponents[8] as UnityEngine.UI.Button;
            this.speedButton = this.mono.bindComponents[9] as UnityEngine.UI.Button;
            this.speedText = this.mono.bindComponents[10] as UnityEngine.UI.Text;
        }
