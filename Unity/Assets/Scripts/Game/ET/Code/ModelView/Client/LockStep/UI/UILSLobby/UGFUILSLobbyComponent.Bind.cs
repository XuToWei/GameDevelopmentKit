...
namespace ET.Client
{
    public partial class UGFUILSLobbyComponent : CodeBind.ICSCodeBind
    {
        ...
        public void InitBind(CodeBind.CSCodeBindMono mono)
        {
            ...
            this.replayButton = this.mono.bindComponents[1] as UnityEngine.UI.Button;
            this.replayPathInputField = this.mono.bindComponents[2] as UnityEngine.UI.InputField;
        }
