...
namespace ET.Client
{
    public partial class ETMonoUIFormLogin
    {
        ...
        [UnityEngine.SerializeField, Sirenix.OdinInspector.FoldoutGroup("BindData"), Sirenix.OdinInspector.ReadOnly]
        private ET.Client.ETMonoWidgetTest m_TestWidgetTest;
        ...
        public ET.Client.ETMonoWidgetTest TestWidgetTest => m_TestWidgetTest;
