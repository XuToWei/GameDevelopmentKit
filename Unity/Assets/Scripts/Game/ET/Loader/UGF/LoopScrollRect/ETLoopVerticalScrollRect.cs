...
{
    /// <summary>
    /// ET 版纵向循环列表：在 ExLoopVerticalScrollRect 基础上，
    /// 当 item 是 AETMonoUGFUIWidget 时，取出时自动添加到所属 UIForm/父 UIWidget 并打开，回收时关闭并移除。
    /// </summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("UI/ET Loop Vertical Scroll Rect")]
    public class ETLoopVerticalScrollRect : ExLoopVerticalScrollRect
    {
