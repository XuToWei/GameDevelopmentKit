    ...
    public sealed class ETMonoEntity : BaseEntity
    {
        ...
        public void OnLoad()
        {
            ...
            else
            {
                ...
                throw new GameFrameworkException($"EntityEventType {this.m_EntityEventType} doesn't exist EntityEvent!");
            }
            this.m_EntityEvent.OnLoad(this.m_UGFEntity);
        }
        ...
        protected override void OnShow(object userData)
        {
            ...
            if (this.m_UGFEntity == default || this.m_EntityEventType != entityData.EntityEventType || entityData.ParentEntity != this.m_UGFEntity.Parent)
            {
                ...
                this.m_EntityEventType = entityData.EntityEventType;
                this.m_UGFEntity = entityData.ParentEntity.AddChild<UGFEntity, Type, ETMonoEntity>(this.m_EntityEventType, this);
