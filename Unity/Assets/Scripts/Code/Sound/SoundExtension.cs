...
namespace Game
{
    public static class SoundExtension
    {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, BaseEntity bindingBaseEntity = null, object userData = null)
        {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingBaseEntity != null ? bindingBaseEntity.Entity : null, userData);
        }
