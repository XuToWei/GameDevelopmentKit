    ...
    public class BuildEditor: EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("BuildModelAndHotfix"))
            {
                ...
                BuildAssembliesHelper.BuildModel(this.codeOptimization, globalConfig.CodeMode);
                BuildAssembliesHelper.BuildHotfix(this.codeOptimization, globalConfig.CodeMode);
