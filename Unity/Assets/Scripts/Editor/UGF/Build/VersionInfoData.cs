...
namespace UGF.Editor
{
    ...
    public class VersionInfoData
    {
        ...
        /// 资源更新下载地址
        /// </summary>
        public string UpdatePrefixUri => Utility.Path.GetRegularPath(Path.Combine(m_ServerPath??string.Empty, m_ResourceVersion??string.Empty, m_Platform.ToString()));
        ...
        {
            return Utility.Json.ToJson(ToVersionInfo());
        }
