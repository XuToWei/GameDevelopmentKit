...
namespace UGF
{
    public static class SoundExtension
    {
        ...
        private static int? s_MusicSerialId { get; set; } = null;

        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            soundComponent.StopMusic();
            
            DRMusic drMusic = DataTables.Instance.DTMusic.GetOrDefault(musicId);
            if (drMusic == null)
            {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, UGFEntity bindingUgfEntity = null, object userData = null)
        {
            DRSound drSound = DataTables.Instance.DTSound.GetOrDefault(soundId);
            if (drSound == null)
            {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingUgfEntity != null ? bindingUgfEntity.Entity : null, userData);
        }

        public static int? PlayUISound(this SoundComponent soundComponent, int uiSoundId, object userData = null)
        {
            DRUISound drUISound = DataTables.Instance.DTUISound.GetOrDefault(uiSoundId);
            if (drUISound == null)
            {
