...
namespace ET
{
    ...
    public class Unit: Entity, IAwake<int>
    {
        ...
        [BsonIgnore]
        public DRUnitConfig Config => DataTables.Instance.DTUnitConfig.Get(this.ConfigId);

        public UnitType Type => (UnitType)DataTables.Instance.DTUnitConfig.Get(this.ConfigId).Type;
