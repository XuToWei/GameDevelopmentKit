...
namespace ET.Server
{
    public static class WatcherHelper
    {
        public static DRStartMachineConfig GetThisMachineConfig()
        {
            ...
            foreach (DRStartMachineConfig config in DataTables.Instance.DTStartMachineConfig.DataList)
            {
        ...
        {
            DRStartProcessConfig startProcessConfig = DataTables.Instance.DTStartProcessConfig.Get(Options.Instance.StartConfig, processId);
