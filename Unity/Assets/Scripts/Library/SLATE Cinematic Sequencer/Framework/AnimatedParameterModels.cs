...
namespace Slate
{
    ...
    ///<summary>An interface for animated_X models</summary>
    public interface IAnimatedParameterModel
    {

        ///<summary>Should step be forced?</summary>
        bool ForceStepMode();
        ///<summary>Amount of curves required to represent data</summary>
		int RequiredCurvesCount();

        ///<summary>Floats to data object</summary>
        object ConvertToObject(params float[] floats);
        ///<summary>Data object to floats</summary>
		float[] ConvertToFloats(object value);

        ///<summary>Nice string for keys</summary>
        string GetKeyLabel(params float[] floats);

        ///<summary>Set field/prop info value on target object with value provided in floats[]</summary>
        void SetDirect(object target, MemberInfo info, params float[] floats);
        ///<summary>Get field/prop info value on target object with value being a float[]</summary>
