...
namespace Slate
{
    ...
    ///<summary>Used to interface with AnimatedParameter and AnimationDataCollection the same, since AnimatedParameters are contained within an AnimationDataCollection.</summary>
