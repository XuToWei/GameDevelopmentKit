...
namespace Slate
{
    ...
    public class CharacterInspector : Editor
    {
        ...
        public override void OnInspectorGUI() {
            ...
            var skins = character.GetComponentsInChildren<Component>().Where(c => c is SkinnedMeshRenderer && ( c as SkinnedMeshRenderer ).sharedMesh.blendShapeCount > 0).Cast<SkinnedMeshRenderer>().ToList();
