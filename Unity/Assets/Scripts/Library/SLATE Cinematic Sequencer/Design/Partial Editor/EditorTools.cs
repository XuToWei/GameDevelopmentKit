...
namespace Slate
{
    ...
    ///<summary>A collections of tools for the editor only</summary>
    public static class EditorTools
    {
        ...
        ///<summary>Gets the GameView panel's resolution size</summary>
        ...
        ///<summary>Set an object's fold state</summary>
        ...
        public static Texture2D GetAudioClipTexture(AudioClip clip, int width, int height) {
            ...
            if ( clip.loadType != AudioClipLoadType.DecompressOnLoad ) {
                ...
                Debug.LogWarning(string.Format("Can't get preview audio texture from audio clip '{0}' because its load type is set to compressed", clip.name), clip);
                return null;
            }

            texture = new Texture2D(width, height, TextureFormat.RGBA32, false);
            float[] samples = new float[clip.samples];
            int step = Mathf.CeilToInt(( clip.samples ) / width);
