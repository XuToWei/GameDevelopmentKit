...
namespace Slate
{
    ...
    public static class AnimatableParameterEditor
    {
        ...
        ///<summary>The gear context menu for all parameters</summary>
        ...
        ///<summary>Used when the Animated Parameter is a property and we don't have a SerializedProperty.</summary>
