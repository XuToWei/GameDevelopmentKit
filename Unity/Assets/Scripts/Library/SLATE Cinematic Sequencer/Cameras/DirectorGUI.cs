...
namespace Slate
{
    ...
    [ExecuteInEditMode]
    ///<summary>Handles subtitles, fades, crossfades etc. Acts as an event dispatcher. GUI should be implemented elsewhere by subscribing to these events.</summary>
    public class DirectorGUI : MonoBehaviour
    {
        ...
        //EVENTS
        ///<summary>Subscribe to any of these events to handle UI.</summary>
...
#if UNITY_EDITOR
        ///<summary>we keep OnGUI only in editor cause it generates garbage. It's not required in runtime.</summary>
        void OnGUI() {
