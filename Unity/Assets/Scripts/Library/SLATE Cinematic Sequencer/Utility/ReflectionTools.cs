...
namespace Slate
{
    ...
    ///<summary>A collection of helper tools relevant to runtime</summary>
    public static class ReflectionTools
    {
        ...
        ///<summary>Creates a delegate out of Method for target instance</summary>
        ...
        ///<summary>Creates and returns an open instance setter for field or property. In JIT is done with IL Emit. In AOT via direct reflection.</summary>
        ...
        ///<summary>Given an instance and a path returns the Field or Property Info from that path</summary>
        public static MemberInfo GetRelativeMember(object root, string path) {
            if ( root == null || string.IsNullOrEmpty(path) ) { return null; }
            return GetRelativeMember(root.GetType(), path);
        }

        ///<summary>Given an type and a path returns the Field or Property Info from that path</summary>
        ...
        ///<summary>Digs into starting type provided and returns instance|Public property/fields paths recursively found, based on predicates provided</summary>
        ...
        // ///<summary>Given a root object and a relative path, gets and returns the member value</summary>
        ...
        // ///<summary>Given a root object and a relative path, sets the member value</summary>
