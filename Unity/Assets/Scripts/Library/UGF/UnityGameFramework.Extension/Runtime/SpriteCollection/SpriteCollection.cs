...
{
    [CreateAssetMenu(fileName = "SpriteCollection", menuName = "UGFExtension/SpriteCollection", order = 0)]
#if ODIN_INSPECTOR
    ...
    public class SpriteCollection : ScriptableObject
    {
        ...
        public IDictionary<string, Sprite> Sprites
        {
            ...
            set { this.m_Sprites.CopyFrom(value); }
        }
        ...
        void SetSprites()
        {
            ...
            {
                m_Sprites.Add(keyValue.Key, keyValue.Value);
            }
        }
