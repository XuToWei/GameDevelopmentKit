...
namespace EnhancedScrollerDemos.FlickSnap
{
    ...
    public class DemoController : MonoBehaviour, IEnhancedScrollerDelegate
    {
        ...
        /// <summary>
        /// Used to offset the start position when calculating the start
        /// cell index. This is useful if you have no padding or spacing
        /// in your scroller because the end position of one cell is the same
        /// as the start position of another cell. Make sure this bias is not
        /// larger than your cell size.
        /// </summary>
        ...
        void Start()
        {
            ...
            // set up the bias on the scroller to determine the start cell index
