...
namespace YIUIBind
{
    ...
    public sealed class UIDataBindImage : UIDataBindSelectBase
    {
        ...
        private async UniTaskVoid ChangeSprite(string resName)
        {
            ...
            if (GameEntry.Resource.HasAsset(resName) == HasAssetResult.NotExist)
            {
            ...
            var sprite = await GameEntry.Resource.LoadAssetAsync<Sprite>(resName);
            if (m_Image != null)
            {
                m_LastSprite   = sprite;
        ...
        private void ReleaseLastSprite()
        {
            ...
            {
                GameEntry.Resource.UnloadAsset(m_LastSprite);
                m_LastSprite = null;
            }
        }
    }
